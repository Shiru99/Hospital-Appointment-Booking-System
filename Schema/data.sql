...
INSERT INTO `Appointments` (
  `id`, `doctor_id`, `patient_id`, `date`, `slot`, `status`, `message`
)
VALUES  
    ( '1', '1234567892', '1234567890','2022-11-22', 'Morning1', 'Active',  'Medical Summary Reports provide an overview of the your personal history, occupational history, health history, psychiatric history, and functioning. These reports are often created by case workers. Ideally, they are also co-signed by the applicant’s doctor, psychologist, or psychiatrist.'),
    ( '2', '1234567892', '1234567891','2022-11-22', 'Morning2', 'Active',  'Medical Summary Reports provide an overview of the your personal history, occupational history, health history, psychiatric history, and functioning. These reports are often created by case workers. Ideally, they are also co-signed by the applicant’s doctor, psychologist, or psychiatrist.'),
    ( '3', '1234567893', '1234567890','2022-11-22', 'Morning3', 'Active',  'Medical Summary Reports provide an overview of the your personal history, occupational history, health history, psychiatric history, and functioning. These reports are often created by case workers. Ideally, they are also co-signed by the applicant’s doctor, psychologist, or psychiatrist.'),
    ( '4', '1234567894', '1234567891','2022-11-22', 'Afternoon1', 'Active',  'Medical Summary Reports provide an overview of the your personal history, occupational history, health history, psychiatric history, and functioning. These reports are often created by case workers. Ideally, they are also co-signed by the applicant’s doctor, psychologist, or psychiatrist.'),
    ( '5', '1234567895', '1234567890','2022-11-22', 'Afternoon2', 'Active',  'Medical Summary Reports provide an overview of the your personal history, occupational history, health history, psychiatric history, and functioning. These reports are often created by case workers. Ideally, they are also co-signed by the applicant’s doctor, psychologist, or psychiatrist.'),
    ( '6', '1234567896', '1234567891','2022-11-22', 'Evening1', 'Active',  'Medical Summary Reports provide an overview of the your personal history, occupational history, health history, psychiatric history, and functioning. These reports are often created by case workers. Ideally, they are also co-signed by the applicant’s doctor, psychologist, or psychiatrist.'),
    ( '7', '1234567896', '1234567890','2022-11-22', 'Evening1', 'Active',  'Medical Summary Reports provide an overview of the your personal history, occupational history, health history, psychiatric history, and functioning. These reports are often created by case workers. Ideally, they are also co-signed by the applicant’s doctor, psychologist, or psychiatrist.')
;
